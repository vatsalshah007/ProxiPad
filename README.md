...
```bash
# Clone the repo
git clone https://github.com/yourusername/ProxiPad.git
cd ProxiPad
...
- [x] Auto-reconnect on Bluetooth drop
...
For bugs, use the [Issues](../../issues) tab. Please include your Android version and device model.
